...
def Optimizer(returnData):
    ...
    Lambda_RA=3 #define the risk aversion parameter
    
    #Calculate the optimal weight for the Mean-Variance-Skewness-Kurtosis Optimisation
    ...
    #Calculate the optimal weight for the Mean-Variance Optimisation
...
def Stat_descriptive(data,optimal_w,opt,sample):
    ...
    opt : string
        "EV" or "SK" to define which optimizer was used to generated optimal_w.

    sample : string
        "IS" or "OS" for in-sample or out-sample dataset.
